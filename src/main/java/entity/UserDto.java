...
public class UserDto implements Serializable {
    ...
    private void saveJpegPhotoToCache() {
    ...
    private String getDescription(boolean isTranslit) {
    ...
    private String getCompany(boolean isTranslit) {
    ...
    private void setValueUserDto(String fieldName, NamingEnumeration values)
    ...
    private String getLastName(boolean isTranslit) {
    ...
    private String getFirstName(boolean isTranslit) {
    ...
    private void setCompanyDn(String companyDn) {
